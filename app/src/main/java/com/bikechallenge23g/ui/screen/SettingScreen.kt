...
import com.bikechallenge23g.ui.composables.CustomSwitch
import com.bikechallenge23g.ui.composables.DropdownSelector
import com.bikechallenge23g.ui.composables.TextCard
import com.bikechallenge23g.ui.composables.TextLabel
...
fun SettingScreen(
    ...
    val distanceUnit =
        listOf(stringResource(id = R.string.km), stringResource(id = R.string.miles))
    val selectedDistanceUnit = remember { mutableStateOf(distanceUnit[0]) }
        ...
        content = { innerPadding ->
            Box(modifier = Modifier.padding(innerPadding)) {
                Column(modifier = Modifier
                    ...
                    DropdownSelector(distanceUnit, selectedItem = selectedDistanceUnit.value) {
